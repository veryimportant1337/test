...
/// Windows-specific implementation of platform installation service operations
class WindowsInstallationService implements IPlatformInstallationService {
  final IPlatformFileHandler _fileHandler;
  final PreferencesService _preferencesService;

  WindowsInstallationService(this._fileHandler, this._preferencesService);
  ...
  Future<void> scanAndStoreEdenExecutable(
    ...
    LoggingService.info(
      'Selected Eden executable for Windows: $selectedExecutable',
    );
  }
